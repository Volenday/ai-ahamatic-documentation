...
| --- | --- | --- | --- |
| T65 | Add Data Administration capability (**C-27**) — definition. **Unblocked 2026-08-02:** family = **Construction**, name = **Data Administration** (`DECISIONS.md` D-13, resolved) | ⏳ Next | `docs/spec/01-business-and-ux/02-prd.md`, `03-platform-capability-model.md` |
| T66 | No-code tier commitment — replace the low-code tier commitment; sever tier from audience in the definitions. **⚠ Scope clarified 2026-08-02 by `DECISIONS.md` D-18:** D-09 reaches the **Builder** application-code path only. This ticket must **not** narrow the spec-defined **Extender** role (`02-governance-and-security/03-access-control-and-tenancy-model.md` §6) or the SDK's "builder **or extender**" framing (`05-integration-and-extensibility-spec.md` §67) — both survive the no-code commitment intact | ⏳ Ready | `01-vision-and-charter.md`, `03-software-and-architecture/02-domain-glossary.md`, `01-business-and-ux/07-competitive-landscape.md` |
