...
| H13 | Security Controls Design | `docs/design/02-identity-access-security/04-security-controls-design.md` | `03-architecture-realization-design.md`; `01-invariant-enforcement-design.md` | 🟢 Ready — no unwritten prerequisite |
| H14 | AI Tooling Security Design | `docs/design/02-identity-access-security/05-ai-tooling-security-design.md` | `04-security-controls-design.md` | ⬜ Pending |
