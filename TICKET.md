...
| H15 | Compliance and Data Residency Design | `docs/design/02-identity-access-security/06-compliance-and-data-residency-design.md` | `02-tenant-isolation-and-access-control-design.md` | 🟢 Ready — no unwritten prerequisite |
| H16 | Data Governance and Privacy Design | `docs/design/02-identity-access-security/07-data-governance-and-privacy-design.md` | `02-tenant-isolation-and-access-control-design.md`; `06-compliance-and-data-residency-design.md` | ⬜ Pending |
