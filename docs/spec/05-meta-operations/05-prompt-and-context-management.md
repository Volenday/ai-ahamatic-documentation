...
| The concrete numeric window and resource values | The specific window, resource, and latency figures assembly keys to. | `03-software-and-architecture/06-non-functional-requirements.md` §8 |
...
- **The concrete numeric window, resource, and latency values** are owned by `03-software-and-architecture/06-non-functional-requirements.md` §8; this document requires that assembly stay within a finite window and keys to those values without minting a number.
