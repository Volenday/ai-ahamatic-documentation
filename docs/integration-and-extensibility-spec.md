...
|---|---|
| Capability confinement | An extension instance invokes only the platform capabilities its own grant names; it cannot reach a capability of C-01–C-22 beyond what it was granted. |
