...
| Platform core and primitives | The platform-provided primitives (C-01–C-22), protected from corruption, unauthorized change, and absorption of untrusted content. |
