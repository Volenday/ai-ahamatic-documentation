...
|---|---|---|---|
| ✅ **D-h** | **RESOLVED 2026-08-18 — `DECISIONS.md` D-49.** Yes — the criteria library gets a dedicated skill, `ai-aha-criteria-doc`, on the identical model `ai-aha-spec-doc`/`ai-aha-design-doc` already provide. Five `CR##` tickets' worth of inline-rule duplication, sharpened by CR05's third artifact class, is the evidence D-21's own deferral was waiting for. **Authorizes P07.** | P07 | Decided |
